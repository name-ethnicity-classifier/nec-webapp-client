    ...
    render() {
        return (
            <div className="privacyPolicyBox">
                ...
                <p>We use &ldquo;cookies&rdquo; to store your email and authorization token. A cookie is a small piece of data that our website stores on your computer, and accesses each time you visit in order to log you into your account. </p>
                ...
                <p>Theodor Peifer<br />teddypeifer@gmail.com</p>
            </div>
        )
    }
