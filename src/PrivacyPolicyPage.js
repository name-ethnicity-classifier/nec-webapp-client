    ...
    render() {
        return (
            <div className="policyBox">
                <h1>Imprint</h1>
                <p>Theodor Peifer<br/>theodorpeifer@gmail<br/>Clemensstraße 80803 Munich, Germany</p>
                ...
                <p>This policy is effective as of 21 December 2021 and was last updated on 24 January 2024. </p>
                ...
                <h2>Communication and Emails:</h2>
                <p>By using our services, you agree to receive communications from us.</p>
                <ul>
                    <li>Service Notifications: Emails from <b>necweb.noreply@gmail.com</b> for important service-related notifications, including account verification, security updates, and essential information about your account.</li>
                    <li>Surveys and Feedback: Occasional emails from  <b>theodorpeifer@gmail.com</b> for the purpose of surveys, user feedback, and improvements to enhance your experience with our services.</li>
                </ul>
                ...
                <p>We use &ldquo;cookies&rdquo; for authentication purposes only. A cookie is a small piece of data that our website stores on your computer, and accesses each time you visit in order to log you into your account. </p>
                <h4>List of cookies in use:</h4>
                <ul>
                    <li>email: This cookie stores your email to facilitate requests and secure account access.</li>
                    <li>token: This cookie holds an authorization token, functioning as a secure key for authorized account access.</li>
                    <li>cookie-consent: This cookie is set if the user accepted to the cookies.</li>
                </ul>
                ...
                <p>Theodor Peifer<br />theodorpeifer@gmail.com</p>
            </div>
        )
    }
